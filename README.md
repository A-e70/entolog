...
is optional, as a second opinion on HEIC and unusual raws. `python3 -m entolog
doctor` says what this machine has.
...
```bash
python3 -m unittest discover -s tests      # 159 tests, no network, no camera
